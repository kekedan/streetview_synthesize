...
flags.DEFINE_float("L1_lambda", 10.0, "weight on L1 term in objective")
...
flags.DEFINE_string("dataset_dir", "/data/vllab1/CVPR/dataset/test/image", "The name of dataset [celebA, mnist, lsun]")
flags.DEFINE_string("datasetB_dir", "/data/vllab1/CVPR/dataset/valid/heatmap", "The name of dataset [celebA, mnist, lsun]")
flags.DEFINE_string("checkpoint_dir", "../../../checkpoint/DCGAN/pix2pix_z", "Directory name to save the checkpoints [checkpoint]")
flags.DEFINE_string("sample_dir", "samples_pix2pix_z", "Directory name to save the image samples [samples]")
