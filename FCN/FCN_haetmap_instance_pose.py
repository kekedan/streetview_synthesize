...
tf.flags.DEFINE_string("data_dir", "/data/vllab1/dataset/CITYSCAPES/CITY_valid/fine_image", "path to dataset")
tf.flags.DEFINE_string("label_dir", "/data/vllab1/CVPR/dataset/valid/heatmap", "path to annotation")
...
tf.flags.DEFINE_string('mode', "test_visual_use_valid", "Mode train/ test/ visualize")
...
def main(argv=None):
    ...
    annotation = tf.placeholder(tf.float32, shape=[None, IMAGE_SIZE_h, IMAGE_SIZE_w, 3], name="annotation")
