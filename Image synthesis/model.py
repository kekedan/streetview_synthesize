...
class DCGAN(object):
    ...
    def eval(self, config):
        f = open('/home/andy/dataset/HW3eval/eval_my.txt', 'r')
        w = open('/home/andy/dataset/HW3eval/output_ori.txt', 'w')
        data = []
        for line in f:
            data.append('/home/andy/dataset/HW3eval/eval/{}'.format(line.split('/')[-1].split('\n')[0]))
        ...
        eval = np.ones(2400, dtype=np.int8)
