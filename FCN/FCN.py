...
tf.flags.DEFINE_string("data_dir", "/home/andy/dataset/CITYSCAPES/for_wonderful_chou/image/", "path to dataset")
tf.flags.DEFINE_string("label_dir", "/home/andy/dataset/CITYSCAPES/for_wonderful_chou/label/", "path to annotation")
tf.flags.DEFINE_string("model_dir", "/home/andy/checkpoint/CITYSCAPES/", "Path to vgg model mat")
...
def main(argv=None):
    ...
    '''
    data = glob(os.path.join(FLAGS.data_dir, "*.png"))
    annotation = glob(os.path.join(FLAGS.label_dir, "*.png"))
    ...
    if FLAGS.mode == "train":
        for itr in xrange(MAX_ITERATION):
            ...
            train_annotations_name = annotation[itr * FLAGS.batch_size:(itr + 1) * FLAGS.batch_size]
        ...
        train_images = scipy.misc.imread(
            '/home/andy/dataset/CITYSCAPES/for_wonderful_chou/image/aachen_000045_000019_leftImg8bit.png').astype(
            np.uint8)
        train_annotations = scipy.misc.imread(
            '/home/andy/dataset/CITYSCAPES/for_wonderful_chou/label/aachen_000045_000019_gtFine_labelIds.png').astype(
            np.uint8)
