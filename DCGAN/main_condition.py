...
flags.DEFINE_string("dataset_dir", "/data/vllab1/CVPR/dataset/train/heatmap", "The name of dataset [celebA, mnist, lsun]")
flags.DEFINE_string("checkpoint_dir", "../../../checkpoint/DCGAN/heatmap", "Directory name to save the checkpoints [checkpoint]")
flags.DEFINE_string("sample_dir", "samples_heatmap", "Directory name to save the image samples [samples]")
